...
import contentTypeFieldSchema from '@/src/content-model/types/contentTypeField';
import styles from '@/src/diagram/components/ContentType/ContentType.module.css';
import {
