...
import styles from './DiagramEdit.module.css';
...
interface DiagramEditProps {
  ...
  initialContentModelPosition: z.infer<typeof contentModelPositionSchema>;
  onContentTypeDrag: (
...
const DiagramEdit: React.FC<DiagramEditProps> = (props) => {
  const {
    contentModel,
  ...
  return (
    ...
    >
      <div
        className={`transition-opacity delay-100 ${
          ...
          >
            {contentModel.map((contentType, i) => (
              <DraggableContentType
                ...
                startPosition={
                  initialContentModelPosition.contentTypes[contentType.sys.id]
                }
                scale={panScale}
                contentType={contentType}
                onDrag={(
                  position: z.infer<typeof contentTypePositionSchema>,
                ) => {
                  setPanChanged(true);
